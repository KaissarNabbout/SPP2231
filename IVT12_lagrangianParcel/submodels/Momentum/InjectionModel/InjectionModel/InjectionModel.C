...
)
{
    ...
    if (inject)
    {
        ...
        scalar preInjectionCpuTime = executionTime.elapsedCpuTime();
        ...
        scalar posInjectionCpuTime = executionTime.elapsedCpuTime();
        
        scalar injectionCpuTime = posInjectionCpuTime - preInjectionCpuTime;
        
        reduce(injectionCpuTime, maxOp<scalar>());
        
        this->owner().injectionCpuTime() += injectionCpuTime;
    }
